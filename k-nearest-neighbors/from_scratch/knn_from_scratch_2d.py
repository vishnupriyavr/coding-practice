...
for point in points['blue']:
    ax.scatter(point[0], point[1], c='blue', s=60)

for point in points['red']:
    ax.scatter(point[0], point[1], c='red', s=60)

new_class_color = 'blue' if knn_predicted_class == 'blue' else 'red'
ax.scatter(query_point[0], query_point[1], c=new_class_color, s=100, marker='*', label='Query Point')

plt.title(f'K-NN Classification (Predicted: {knn_predicted_class})')
plt.show()